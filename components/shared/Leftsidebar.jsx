...
const Leftsidebar = () => {
  return (
    <div className="hide-scroll-bar  hidden dark:bg-dark-1 md:flex items-start px-5 py-4 justify-start space-y-2 flex-col col-span-4 lg:col-span-3 max-h-screen h-screen overflow-y-scroll">
